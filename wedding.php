...
<div class="container">
    ...
    <h2>Wedding Packages</h1>
         
        <ul>
        <li><span class="mitem">(Include facial,Nail extension,mehandi,manicure and pedicure,hair styling and one Bridesmaid makeup)</span> - <span class="price">Rs.20,000</span></li>
