<?php
include 'controller/fetch_services.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div>
            ...
            <select id="name" name="name" required>
                ...
                foreach ($services as $service) {
                    echo "<option value='" . htmlspecialchars($service['id'], ENT_QUOTES, 'UTF-8') . "'>" . htmlspecialchars($service['name'], ENT_QUOTES, 'UTF-8') . "</option>";
                }
                ?>
            </select>
        </div>
