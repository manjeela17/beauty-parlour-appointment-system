...
<div class="container">
    <div class="mprice-list">
        <h2>Makeup</h2>
        <ul>
            <li><span class="mitem">Bridal</span> - <span class="price">Rs.10,000</span></li>
            <li><span class="mitem">Reception</span> - <span class="price">Rs.6,500</span></li>
            <li><span class="mitem">Party</span> - <span class="price">Rs.1,500</span></li>
           
        </ul>
    </div>
</div>
<a href="service.php" class="button"> Back to Service</a> 
</body>
</html>
